...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .send(
        "service_jp141n7", // Replace with your actual Service ID
        "template_czofru4", // Replace with your actual Template ID
        templateParams,
        "a73YWGs31nzLhTqzd" // Replace with your actual User ID
      )
      .then(
        (result) => {
    ...
    <div className="w-full lg:py-20 pt-20 pb-28 flex lg:flex-row lg:justify-between lg:gap-0 gap-8 items-center flex-col">
      <div className="lg:w-1/2 px-6 lg:text-start text-center">
        ...
        <p className="text-zinc-300 text-xl mt-4">
          ...
          you can contact me via the form below. I'll get back to you as soon as
          possible.
        </p>
      ...
      <form onSubmit={sendEmail} className="lg:w-1/2 px-8">
        ...
        <div className="mt-4">
          <label htmlFor="message" className="text-white text-xl font-semibold">
            Message
          </label>
          <textarea
            id="message"
